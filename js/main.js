    ...
    d3.text("dat/vast2015trajectory.html", function(e, __vast2015trajectory__) {
        ...
        d3.text("dat/biography.html", function(e, __biography__) {
            ...
            __containers__.news = text_outer.append("div").attr("id", "newscontainer").classed("hidden", true);
                ...
                text_container.append('g').html('<a href="https://scholar.google.com/citations?user=YiNKGP0AAAAJ" target="_blank"> <img style="max-width: 20%; margin-right: 20px; margin-left: 5px; margin-top: 0px; margin-bottom: 15px;" src="img/profile.png" align="left"></a>');
