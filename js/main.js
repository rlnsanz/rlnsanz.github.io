...
function __write__() {
    ...
    d3.text("dat/vast2015trajectory.html", function (e, __vast2015trajectory__) {
        ...
        d3.text("dat/biography.html", function (e, __biography__) {
            ...
            text_container.append('g').html('<ul class="hidden" style="margin-left: 10px;"> <li><a id="welcomelink" class="active" onclick="__welcome__()" style="cursor: pointer;">Welcome</a></li> <li><a id="researchlink" onclick="__research__()" style="cursor: pointer;">Publications</a></li> <li><a id="newslink" onclick="__news__()" style="cursor: pointer;">Talks</a></li> <li><a id="cvlink" href="https://github.com/ucbrise/flor" target="_blank">Code</a></li></ul> ');
